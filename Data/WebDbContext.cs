    ...
    public class WebDbContext : IdentityDbContext<User, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                ...
                new Order { OrderId = 4, UserId = 1, OrderDate = new DateTime(2026, 4, 13), TotalPrice = 1500000, ShippingAddress = "Apt 4B, 22nd Street, District 1, Ho Chi Minh City, Vietnam", ReceiverPhone = "0944332211", OrderStatus = "Completed", PaymentStatus = "Paid", Delivered = true, DeliveryDate = new DateTime(2026, 4, 13) },
                new Order { OrderId = 5, UserId = 1, OrderDate = new DateTime(2026, 4, 14), TotalPrice = 3200000, ShippingAddress = "71-75 Shelton Street, Covent Garden, London WC2H 9JQ, UK", ReceiverPhone = "0355667788", OrderStatus = "Completed", PaymentStatus = "Paid", Delivered = true, DeliveryDate = new DateTime(2026, 4, 14) },
                new Order { OrderId = 6, UserId = 1, OrderDate = new DateTime(2026, 4, 15), TotalPrice = 950000, ShippingAddress = "Block C, FPT University Campus, Hoa Lac Hi-Tech Park, Hanoi", ReceiverPhone = "0322114455", OrderStatus = "Completed", PaymentStatus = "Paid", Delivered = true, DeliveryDate = new DateTime(2026, 4, 15) },
                new Order { OrderId = 7, UserId = 1, OrderDate = new DateTime(2026, 4, 16), TotalPrice = 1800000, ShippingAddress = "202 Jervois Road, Herne Bay, Auckland 1011, New Zealand", ReceiverPhone = "0977889900", OrderStatus = "Completed", PaymentStatus = "Paid", Delivered = true, DeliveryDate = new DateTime(2026, 4, 16) }
            );
